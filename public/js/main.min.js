    ...
    var n = {
        35: ()=>{
            !function() {
                ...
                function r(n, e) {
                    n.preventDefault();
                    var t, a = n.target.checkValidity(), s = !e || (t = n.target).querySelector("#signonpassword").value === t.querySelector("#password2").value;
                    document.getElementById("repeat-password-feedback").style.display = s ? "none" : "block",
                ...
                function d(n, e) {
                    ...
                    t.open("POST", "".concat(CONFIG.docsApiUrl, "/user/").concat("login-form" === n.getAttribute("name") ? "login" : "register"), !0),
                    t.setRequestHeader("Content-Type", "application/json"),
                    t.onreadystatechange = function() {
                        this.readyState === XMLHttpRequest.DONE && this.status >= 200 && this.status < 300 ? (p(n, "Success! Redirecting...", "success"),
                        "register" === n.getAttribute("name") && window.open("/newsletter", "_blank"),
                        location.reload()) : this.readyState === XMLHttpRequest.DONE && p(n, this.response, "error")
                    }
                    ,
                ...
                function p(n, e) {
                    ...
                    "error" === t ? (a.classList.add("text-danger"),
                    a.classList.remove("text-success")) : "success" === t ? (a.classList.add("text-success"),
                    a.classList.remove("text-danger")) : (a.classList.remove("text-success"),
                ...
                document.addEventListener("dpl_loaded", (function() {
                    ...
                    a = e.querySelector('[href="#navbarLogin-signup"]'),
                    s = e.querySelector("#navbarLogin-login"),
                    o = e.querySelector('[href="#navbarLogin-login"]'),
                    l = document.querySelector("form#login"),
                    i = document.querySelector("form#register"),
                    c = document.querySelector(".mdb-logout-button"),
                    document.querySelectorAll(".auth-modal-toggle[data-auth-modal-tab]").forEach((function(l) {
                        l.addEventListener("click", (function(l) {
                            var i = l.target.getAttribute("data-auth-modal-tab");
                            "sign-in" === i ? (t.classList.remove("in", "show", "active"),
                            a.classList.remove("active", "show"),
                            s.classList.add("in", "show", "active"),
                            o.classList.add("active", "show")) : "sign-up" === i && m(),
                            n ? mdb.Modal.getOrCreateInstance(e).show() : $(e).modal("show")
                        }
                        ))
                    }
                    )),
                    e.addEventListener("hidden.bs.modal", m),
                    n && document.querySelectorAll(".form-auth-mdb").forEach((function(n) {
        ...
        768: ()=>{
            ...
            document.addEventListener("dpl_loaded", (function(e) {
                ...
                function a() {
                    var t;
                    t = e.detail.isLoggedIn ? e.detail.isPro && !e.detail.isProSubscription ? "PRO" : e.detail.isBundlePro ? "BUNDLE" : e.detail.userSubscriptionStatus : "UNLOGGED",
                    dataLayer.push({
        ...
        217: (n,e,t)=>{
            ...
            var i = ["AT", "BE", "BG", "HR", "CY", "CZ", "DK", "EE", "FI", "FR", "GR", "ES", "IE", "LT", "LU", "LV", "MT", "NL", "DE", "PL", "PT", "RO", "SK", "SI", "SE", "HU", "GB", "IT"]
              , c = a({
                ...
                template: function(n) {
                    var e, t, a = (e = navigator.language.split("-"),
                    t = 2,
                    function(n) {
                        if (Array.isArray(n))
                            return n
                        ...
                        if (null != t) {
                            var a, s, o = [], l = !0, i = !1;
                            try {
                                for (t = t.call(n); !(l = (a = t.next()).done) && (o.push(a.value),
                                !e || o.length !== e); l = !0)
                                    ;
                            } catch (n) {
                                i = !0,
                        ...
                        if (n) {
                            ...
                            "Map" === t || "Set" === t ? Array.from(n) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? l(n, e) : void 0
                        }
                    }(e, t) || function() {
                        throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                    }())[1], s = void 0 === a ? navigator.language : a;
              ...
              , Z = a({
                selector: ["#dpl-navbar-new-right-buttons", "#dpl-navbar-right-buttons-new", "#dpl-navbar-right-buttons", "#dpl-navbar-v5-legacy-right-buttons"],
                template: function(n) {
                    var e = getCurrentTechnology()
                      , t = document.querySelector("#dpl-navbar-v5-legacy-right-buttons")
            ...
            function X(n) {
                ...
                if (n.isProSubscription || e && (n.isPro || n.hasAnyOrder))
                    document.querySelectorAll(".mdb-pro-example").forEach((function(n) {
                    ...
                    if (document.querySelectorAll(".mdb-pro-example").forEach((function(n) {
                        document.querySelectorAll(a).forEach((function(e) {
                            e.parentElement.parentElement.parentElement.parentElement.contains(n) && (e.setAttribute(o, "modal"),
                            e.setAttribute(l, "#apiRestrictedModal"),
                            e.setAttribute("type", "button"),
                            t ? e.removeAttribute("href") : e.setAttribute("href", "#"))
                        }
                        ))
                    }
                    )),
                    document.querySelector(".mdb-docs-content-pro") && !["/docs/standard/components/modal/"].includes(window.location.pathname)) {
                        ...
                        if (i && (i.setAttribute(o, "modal"),
                        i.setAttribute(l, "#apiRestrictedModal"),
                        i.setAttribute("type", "button"),
                        t ? i.removeAttribute("href") : i.setAttribute("href", "#"),
                        i.classList.contains("active"))) {
                            var c = document.querySelector(s);
                            t ? new mdb.Tab(c).show() : $(c).tab("show")
                        }
                        var r = document.querySelector("#docs-tab-examples");
                        if (r && !t && (r.setAttribute(o, "modal"),
                        r.setAttribute(l, "#apiRestrictedModal"),
                    ...
                    p.initEvent("hide_pro_docs_init", !0, !0),
                ...
                template: function(n) {
                    ...
                    function(n) {
                        ...
                        if (n) {
                            ...
                            var t = Object.prototype.toString.call(n).slice(8, -1);
                            return "Object" === t && n.constructor && (t = n.constructor.name),
                            "Map" === t || "Set" === t ? Array.from(n) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? cn(n, e) : void 0
                        }
                    }(e, t) || function() {
                        throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
                    }())[1], s = void 0 === a ? navigator.language : a;
              ...
              , pn = a({
                ...
                mounted: function() {
                    ...
                    jQuery(document).ready((function(n) {
                        var e, t, a, s, o = getCurrentTechnology(), l = "mdb_".concat(o, "_last_seen_notification=");
                        document.getElementById("navbarNotification").addEventListener("show.bs.dropdown", (function() {
                            ...
                            document.cookie = l + Date.now() + "; expires=" + t.toUTCString() + "; path=/",
                            e.is(":visible") && e.hide()
                        }
                        )),
                        e = 0,
                        t = n("#navbarNotificationContent").find(".dropdown-item"),
            ...
            function bn(n) {
                return function(n) {
                    ...
                    if (n) {
                        ...
                        var t = Object.prototype.toString.call(n).slice(8, -1);
                        return "Object" === t && n.constructor && (t = n.constructor.name),
                        "Map" === t || "Set" === t ? Array.from(n) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? un(n, e) : void 0
                    }
                }(n) || function() {
            ...
            window.addEventListener("DOMContentLoaded", (function() {
                ...
                t.setRequestHeader("Content-Type", "application/json"),
                t.onreadystatechange = function() {
                    var a = [o, c, r, d, m, b, Q, u, y, f, v, h, x, w, S, k, g, P, A, B, E, C, M, R, D, U, O, N, I, F, T, _, L, q, Y, j, V, H, W, G, z, en, tn, nn, Z, K, J, an, sn]
        ...
        610: ()=>{
            "use strict";
            document.addEventListener("dpl_loaded", (function() {
                var n, e, t, a, s = window.location.href.match(/(standard|jquery|angular|react|vue)/), o = s ? s[0] : "standard", l = document.getElementById("navbarNotification");
                l && (l.addEventListener("click", (function() {
                    var n, e = document.getElementById("navbarNotificationCounter"), t = new Date;
                    t.setTime(t.getTime() + 15552e6),
                    document.cookie = "mdb_".concat(o, "_last_seen_notification=").concat(Date.now(), "; expires=").concat(t.toUTCString(), "; path=/"),
                    ((n = e).offsetWidth || n.offsetHeight || n.getClientRects().length) && (e.style.display = "none")
                }
                )),
                n = 0,
                e = document.getElementById("navbarNotificationContent").querySelectorAll(".dropdown-item"),
                t = document.getElementById("navbarNotificationCounter"),
                a = getCookie("mdb_".concat(o, "_last_seen_notification")),
        ...
        923: (n,e,t)=>{
            ...
            var c = function() {
                function n() {
                    ...
                    this.stars = s(document.querySelectorAll(".review-rating")),
                    this.form = document.querySelector("#new_rating"),
                    this.formLoader = document.querySelector("#reviews-form-loader"),
                    this.reviewsList = document.querySelector("#reviews-list"),
                    this.alertInstance = mdb.Alert.getInstance(document.getElementById("review-alert-danger")),
                    this.userData = null,
                    this.reviews = null,
                ...
                (t = [{
                    ...
                    value: function(n) {
                        if (this.form) {
                            if (this.userData = n,
                            this.productId = this.form.dataset.product || this.reviewsList.dataset.product,
                            !n.isLoggedIn) {
                    ...
                    value: function() {
                        ...
                        for (var t in e.value = 5,
                        this.stars)
                            this.stars[t].addEventListener("mouseover", (function(t) {
                    ...
                    value: function() {
                        ...
                        l.open("POST", "".concat(CONFIG.docsApiUrl, "/reviews/add"), !0),
                        l.setRequestHeader("Content-Type", "application/json"),
                        l.onreadystatechange = function() {
                            this.readyState === XMLHttpRequest.DONE && this.status >= 200 && this.status < 300 ? (n.form.classList.add("d-none"),
                            document.querySelector("#review-added-box").classList.remove("d-none"),
                            document.querySelector("#form-review-stars").innerHTML = n._getStarsTemplate(e),
                            document.querySelector("#form-review-content").innerText = s) : this.readyState === XMLHttpRequest.DONE && n._showAlertError(),
                            n._hideLoaderForm()
                        }
                        ,
                        l.onerror = function() {
                    ...
                    value: function() {
                        ...
                        e.open("GET", "".concat(CONFIG.docsApiUrl, "/reviews/").concat(this.productId), !0),
                        e.setRequestHeader("Content-Type", "application/json"),
                        e.onreadystatechange = function() {
                            this.readyState === XMLHttpRequest.DONE && this.status >= 200 && this.status < 300 ? (n.reviews = JSON.parse(e.response),
                            n.generateLatestReviews(),
                            n.generateTopReviews(),
                            n.loadRatingData()) : this.readyState === XMLHttpRequest.DONE && this.status,
                            document.querySelectorAll(".reviews-list-loaded").forEach((function(n) {
                                return n.remove()
                            }
                            ))
                        }
                    ...
                    value: function() {
                        var n, e = "", t = a(this.reviews.filter((function(n) {
                            return 1 === n.featured
                        }
                        )));
                        try {
                    ...
                    value: function() {
                        ...
                        document.querySelector("#reviews-product-stars").innerHTML = this._getStarsTemplate(n),
                        document.querySelector("#reviews-average-rating").innerText = n,
                        document.querySelector("#reviews-product-count").innerText = this.reviews.length
                    }
                }, {
                    key: "getReviewsListPage",
                    value: function(n) {
                        var e, t = "", s = this.reviewsOnPage, o = a(this.reviews.slice((n - 1) * s, s * n));
                        try {
                            for (o.s(); !(e = o.n()).done; ) {
                                var l = e.value;
        ...
        434: ()=>{
            ...
            document.addEventListener("dpl_loaded", (function() {
                var n, e = void 0 !== window.mdb && "undefined" != typeof mdb, t = e ? 'a[data-mdb-toggle="modal"]' : 'a[data-toggle="modal"]', o = e ? 'a[data-mdb-toggle="collapse"]' : 'a[data-toggle="collapse"]', l = {}, i = document.getElementById("modalOpenSnippet") || document.getElementById("modalOpenSnippetRestricted");
                e && (n = new mdb.Modal(i)),
                m() || -1 === document.cookie.indexOf("wordpress_logged_in_") || p(),
                document.querySelector("main").addEventListener("click", (function(c) {
                    if (Array.from(c.target.children).some((function(n) {
                        ...
                        var r = c.target
                          ...
                          , f = function(n) {
                            ...
                            "Standard" === t && (s = e),
                            "Vue" === t && (s.html = e.template,
                            s.css = e.css,
                            s.javascript = e.script.replace(/<(|\/)script[^>]*>/g, "")),
                            s
                        }(document.getElementById(u.getAttribute("aria-controls")).querySelector(".docs-pills ul"));
                        "modalOpenSnippet" === i.id && (document.querySelector(".mdb-snippets-prepare-text").classList.remove("d-none"),
                        document.querySelector(".mdb-snippets-ready-text").classList.add("d-none"),
                        document.querySelector(".open-snippet").classList.add("disabled"),
                        document.querySelector(".open-snippet").querySelector(".spinner-border").classList.remove("d-none")),
                        e ? n.show() : $(i).modal("show"),
                        s({
                            ...
                            e = function(e) {
                                ...
                                n.loggedin ? m() ? d(n, t) : p((function() {
                                    ...
                                    a = function(n) {
                                        n = "string" == typeof n ? JSON.parse(n) : n,
                                        i.querySelector("a.open-snippet").setAttribute("href", "/snippets/" + o + "/temp/" + n.insertId + "?action=prism_export"),
                                        b()
                                    }
                                    ,
                                    s({
                ...
                function d(n, e) {
                    ...
                    !function(n, e, t) {
                        ...
                        s ? (s = "string" == typeof s ? JSON.parse(s) : s,
                        i.querySelector("a.open-snippet").setAttribute("href", "/snippets/" + t + "/" + a + "/" + s.insertId),
                        b()) : p((function() {
                            return d(n, e)
                        }
                        ))
                ...
                function b() {
                    "modalOpenSnippet" === i.id && (document.querySelector(".mdb-snippets-prepare-text").classList.add("d-none"),
                    document.querySelector(".mdb-snippets-ready-text").classList.remove("d-none"),
                    document.querySelector(".open-snippet").classList.remove("disabled"),
                    document.querySelector(".open-snippet").querySelector(".spinner-border").classList.add("d-none"))
                }
            ...
            e = ["angular", "react", "vue"],
            ("eCommerce" !== (t = a()) && "admin" !== t && -1 === e.indexOf(n[1]) && -1 === e.indexOf(n[2]) && -1 === e.indexOf(n[3]) || "jQuery" === t) && document.addEventListener("DOMNodeInserted", (function(n) {
